...
<div class="container text-center my-3">
    <h2>अपनी परेशानी हमसे साझा करें / हमें सुझाव दें | </h2>
</div>
<div class="container-fluid">
<div class="row">
    <div class="col-lg-6 col-md-6 col-12">
    <img src="1.jpg" class="img-fluid contact_img" alt="">
    </div>
    <div class="col-lg-6 col-md-6 col-12">
    <form>
  <div class="form-group">
    <!-- <label for="exampleFormControlInput1">Email address</label> -->
    <input type="text" class="form-control my-2" id="exampleFormControlInput1" placeholder="नाम ">
    <input type="number" class="form-control my-2" id="exampleFormControlInput1" placeholder="फोन नम्बर ">
    <input type="email" class="form-control my-2" id="exampleFormControlInput1" placeholder="ईमेल ">
</div>
  <div class="form-group">
  ...
  <form>
  <div class="form-group">
    <label for="exampleFormControlFile1">फाइल अपलोड करें | </label>
    <input type="file" class="form-control-file" id="exampleFormControlFile1">
  </div>
</form>
  <button type="submit" class="btn btn-primary">हमें भेजें </button>
</form>
    </div>
    </div>
</div>
