...
<section class="my-2 text-center">
    ...
    <img src="22.jpg" class="img-fluid about_img" alt="">
    </div>
    <div class="col-lg-6 col-md-6 col-12">
    <h2 class="display-5 my-3">हम टीम "उम्मीद" हैं |    </h2>
    <p class="py-2">"हम किसान" हमारी एक प्रोजेक्ट है | </p>
    <a href="home.php" class="btn btn-danger">check more</a>
    </div>
    </div>
    </div>
</section>
    <div class="container-fluid text-center">
        <h2 class="bg-danger">हमारी टीम </h2>
        <div class="row">
          <div class="col-lg-3 col-md-3 col-12">
          <div class="card" style="width: 18rem;">
  <img src="33.jpg" class="card-img-top image-fluid" alt="...">
  <div class="card-body">
