...
<div class="row">
  ...
  खेत में पानी डालते वक्त पानी की बर्बादी कैसे कम करें | 
  </a>
  <a href="#" class="list-group-item bg-dark text-light text-center">बारिश के पानी का उपयोग कैसे करें | </a>
  <a href="#" class="list-group-item bg-dark text-light text-center ">बाढ़ के पानी का उपयोग कैसे करें | </a>
</div>
    </div>
    </div>
</div>
