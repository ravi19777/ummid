...
<div class="row">
  ...
  <a href="#" class="list-group-item bg-dark text-light text-center">फसल के बचे हुए चीजों से उर्वरक/खाद कैसे बनायें | </a>
  <a href="#" class="list-group-item bg-dark text-light text-center ">किस फसल में कब और कितना उर्वरक/खाद दें </a>
</div>
    </div>
    </div>
</div>
